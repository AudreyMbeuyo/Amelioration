                    ...
                    <ul class="divide-y divide-gray-200">
                        ...
                        <li class="px-4 py-4 sm:px-6 hover:bg-gray-50">
                            <div class="flex items-center justify-between">
                                ...
                                <div>
                                    <a href="{{ route('matieres.presences', $matiere) }}" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-orange hover:bg-opacity-90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange">
                                        Voir les présences
                                    </a>
                                </div>
                            </div>
