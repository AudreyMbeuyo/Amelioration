...
public class EtudiantResource {
     ...
     */
    @PostMapping("")
    public Mono<ResponseEntity<Etudiant>> createEtudiant(@RequestBody Etudiant etudiant) throws URISyntaxException {
     ...
     */
    @PutMapping("/{id}")
    public Mono<ResponseEntity<Etudiant>> updateEtudiant(
    ...
    public Mono<ResponseEntity<Etudiant>> partialUpdateEtudiant(
        @PathVariable(value = "id", required = false) final Long id,
        @RequestBody Etudiant etudiant
    ) throws URISyntaxException {
        ...
        return etudiantRepository
            ...
            .flatMap(exists -> {
                ...
                Mono<Etudiant> result = etudiantRepository
    ...
    public Mono<List<Etudiant>> getAllEtudiants(
        @RequestParam(name = "eagerload", required = false, defaultValue = "true") boolean eagerload
    ) {
        LOG.debug("REST request to get all Etudiants");
        if (eagerload) {
            return etudiantRepository.findAllWithEagerRelationships().collectList();
        } else {
            return etudiantRepository.findAll().collectList();
        }
    }

    /**
     * {@code GET  /etudiants} : get all the etudiants as a stream.
     * @return the {@link Flux} of etudiants.
     */
    @GetMapping(value = "", produces = MediaType.APPLICATION_NDJSON_VALUE)
    public Flux<Etudiant> getAllEtudiantsAsStream() {
        LOG.debug("REST request to get all Etudiants as a stream");
     ...
     */
    @GetMapping("/{id}")
    public Mono<ResponseEntity<Etudiant>> getEtudiant(@PathVariable("id") Long id) {
        LOG.debug("REST request to get Etudiant : {}", id);
        Mono<Etudiant> etudiant = etudiantRepository.findOneWithEagerRelationships(id);
     ...
     */
    @DeleteMapping("/{id}")
    public Mono<ResponseEntity<Void>> deleteEtudiant(@PathVariable("id") Long id) {
