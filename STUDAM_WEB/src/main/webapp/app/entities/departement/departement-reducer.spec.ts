...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEPARTEMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DEPARTEMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DEPARTEMENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DEPARTEMENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DEPARTEMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DEPARTEMENT actions', async () => {
      const arg = 42666;
