  ...
  return (
    <div>
      <h2 id="departement-heading" data-cy="DepartementHeading">
        <Translate contentKey="studamWebApp.departement.home.title">Departements</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="studamWebApp.departement.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/departement/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="studamWebApp.departement.home.createLabel">Create new Departement</Translate>
          </Link>
        </div>
      </h2>
        ...
        {departementList && departementList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="studamWebApp.departement.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('nom')}>
                  <Translate contentKey="studamWebApp.departement.nom">Nom</Translate>{' '}
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="studamWebApp.departement.home.notFound">No Departements found</Translate>
            </div>
          )
        )}
      </div>
