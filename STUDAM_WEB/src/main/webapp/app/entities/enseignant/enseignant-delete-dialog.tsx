...
import { deleteEntity, getEntity } from './enseignant.reducer';
...
export const EnseignantDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="studamWebApp.enseignant.delete.question">
        <Translate contentKey="studamWebApp.enseignant.delete.question" interpolate={{ id: enseignantEntity.id }}>
