...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ESTPRESENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ESTPRESENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ESTPRESENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ESTPRESENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ESTPRESENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ESTPRESENT actions', async () => {
      const arg = 42666;
