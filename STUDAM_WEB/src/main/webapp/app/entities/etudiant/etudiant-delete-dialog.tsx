...
import { deleteEntity, getEntity } from './etudiant.reducer';
...
export const EtudiantDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="studamWebApp.etudiant.delete.question">
        <Translate contentKey="studamWebApp.etudiant.delete.question" interpolate={{ id: etudiantEntity.id }}>
