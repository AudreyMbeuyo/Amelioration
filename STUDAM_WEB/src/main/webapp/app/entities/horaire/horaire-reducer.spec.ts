...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './horaire.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HORAIRE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_HORAIRE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_HORAIRE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_HORAIRE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_HORAIRE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_HORAIRE actions', async () => {
      const arg = 42666;
