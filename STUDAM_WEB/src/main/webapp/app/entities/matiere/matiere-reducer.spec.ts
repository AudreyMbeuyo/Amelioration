...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './matiere.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MATIERE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MATIERE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MATIERE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_MATIERE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_MATIERE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MATIERE actions', async () => {
      const arg = 42666;
