    ...
    if (!department) {
        return (
            <div className="text-center py-12">
                ...
                <h3 className="mt-2 text-sm font-medium text-gray-900">Département non trouvé</h3>
                <p className="mt-1 text-sm text-gray-500">Le département demandé n&apos;existe pas.</p>
                <div className="mt-6">
                    <Link
        ...
        <div className="space-y-6">
            ...
            <div className="md:flex md:items-center md:justify-between">
                        ...
                        <ol className="flex items-center space-x-4">
                            ...
                            <li>
                                <div className="flex items-center">
                                    ...
                                    <span className="ml-4 text-sm font-medium text-gray-500">{department.nom}</span>
                                </div>
                            </li>
                        </ol>
                    </nav>
                ...
                <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                  ...
                  Créé le {new Date(department.dateCreation).toLocaleDateString('fr-FR')}
                </span>
                            </div>
                        </div>
                    </div>
                ...
                <div className="mt-4 flex space-x-3 md:mt-0 md:ml-4">
                    ...
                    <Link
                        href={`/admin/departments/${department.id}/chief`}
                                ...
                                {teachers.map((teacher) => (
                                    <div key={teacher.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                                        <div className="flex items-center">
                                            ...
                                            <div className="ml-3">
                                                <p className="text-sm font-medium text-gray-900">{teacher.nom}</p>
                                                <p className="text-xs text-gray-500">{teacher.specialite}</p>
                                            </div>
                                        </div>
                                        <div className="text-right">
                                            <p className="text-sm text-gray-900">{teacher.courses} cours</p>
                                    ...
                                    <div key={student.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                                        <div className="flex items-center">
                                            <div className="w-8 h-8 bg-blue-500 rounded-full flex items-center justify-center text-white text-xs font-medium">
                                                {student.matricule.slice(-2)}
                                            </div>
                                            <div className="ml-3">
                                                <p className="text-sm font-medium text-gray-900">{student.nom}</p>
                                                <p className="text-xs text-gray-500">{student.matricule} - {student.classe}</p>
                                            </div>
                                        </div>
                                        <div className="text-right">
                                            <p className="text-sm text-gray-900">{student.niveau}</p>
                                        </div>
                                    </div>
                                ))}
                            </div>
                        ...
                        <div className="px-4 py-5 sm:p-6">
                            ...
                            {department.chef ? (
                                <div className="space-y-3">
                                    <div className="flex items-center">
                                        <div className="w-12 h-12 bg-gradient-to-br from-[#1B396A] to-[#2563eb] rounded-full flex items-center justify-center text-white font-medium">
                                            {department.chef.nom.charAt(0)}
                                        </div>
                                        <div className="ml-3">
                                            <p className="text-sm font-medium text-gray-900">{department.chef.nom}</p>
                                            <p className="text-xs text-gray-500">{department.chef.specialite}</p>
                                        </div>
                                    </div>
                                ...
                                <div className="text-center py-4">
                                    ...
                                    <h4 className="mt-2 text-sm font-medium text-gray-900">Aucun chef assigné</h4>
                                    <p className="mt-1 text-sm text-gray-500">Assignez un chef à ce département.</p>
                                    <Link
                                        href={`/admin/departments/${department.id}/chief/assign`}
                    ...
                    {department.budget && (
                        <div className="bg-white shadow rounded-lg">
                            <div className="px-4 py-5 sm:p-6">
                                ...
                                <div className="text-center">
                                    <div className="text-2xl font-bold text-[#F26419]">
                                        {department.budget.toLocaleString('fr-FR')} FCFA
                                    </div>
                                    <p className="text-sm text-gray-500 mt-1">Exercice 2025</p>
                                </div>

                                <div className="mt-4">
                                    <Link
                                        href={`/admin/departments/${department.id}/budget`}
                                        className="w-full text-center inline-flex items-center justify-center px-3 py-2 border border-gray-300 shadow-sm text-sm leading-4 font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50"
                                    >
                                        Gérer le budget
                                    </Link>
                    ...
                    <div className="bg-white shadow rounded-lg">
                        <div className="px-4 py-5 sm:p-6">
                            ...
                            <div className="text-sm text-gray-600 space-y-2">
                                <div>
                                    <strong>Créé :</strong> {new Date(department.dateCreation).toLocaleDateString('fr-FR')}
                                </div>
                                <div>
                                    <strong>Dernière modification :</strong> {new Date(department.lastUpdate).toLocaleDateString('fr-FR')}
                                </div>
                                <div>
                                    <strong>Statut :</strong>
                                    <span className={`ml-1 ${department.status === 'active' ? 'text-green-600' : 'text-gray-600'}`}>
                    {department.status === 'active' ? 'Actif' : 'Inactif'}
                  </span>
                                </div>
                            </div>
