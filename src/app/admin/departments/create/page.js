...
export default function CreateDepartment() {
    ...
    const loadAvailableChiefs = async () => {
        try {
            // Données simulées - utilisateurs sans département ou avec rôle chef_departement
            const mockChiefs = [
                {
                    id: 10,
    ...
    const handleChange = (e) => {
        ...
        // Génération automatique du code département
        if (name === 'nom') {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setSuccessMessage(`Département "${formData.nom}" créé avec succès !`);

            // Rediriger vers la liste des départements après 2 secondes
            setTimeout(() => {
            ...
            setErrors({ general: error.message || 'Erreur lors de la création du département' });
        } finally {
            setLoading(false);
        }
    };
        ...
        <div className="space-y-6">
            ...
            <div className="md:flex md:items-center md:justify-between">
                <div className="flex-1 min-w-0">
                    ...
                    <p className="mt-1 text-sm text-gray-500">
                        Ajoutez un nouveau département académique à votre établissement.
                    </p>
                </div>
            </div>
                ...
                <form onSubmit={handleSubmit} className="divide-y divide-gray-200">
                    <div className="px-4 py-5 sm:p-6">
                        <div className="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                            ...
                            <div className="sm:col-span-6">
                                ...
                                <p className="mt-1 text-sm text-gray-500">
                                    Définissez les informations principales du département.
                                </p>
                            </div>
                  ...
                  />
                            ...
                            <div className="sm:col-span-6">
                                ...
                                <p className="mt-1 text-sm text-gray-500">
                                    Assignez un chef de département et définissez les informations de contact.
                                </p>
                            </div>
                            ...
                            <div className="sm:col-span-3">
                                ...
                                <div className="mt-1">
                                    ...
                                    <p className="mt-1 text-xs text-gray-500">
                                        Vous pourrez assigner ou modifier le chef plus tard.
                                    </p>
                                </div>
                            </div>
            ...
            <div className="bg-blue-50 rounded-lg p-6">
                <h3 className="text-lg font-medium text-blue-900 mb-4">
                    Conseils pour la création de département
                </h3>
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div>
                        <h4 className="text-sm font-medium text-blue-900 mb-2">Structure organisationnelle</h4>
                        <ul className="text-sm text-blue-700 space-y-1">
                            <li>• Choisissez un nom clair et descriptif</li>
                            <li>• Le code doit être unique et mémorable</li>
                            <li>• Assignez un chef compétent et disponible</li>
                            <li>• Définissez clairement la mission</li>
                        </ul>
                    </div>
                    <div>
                        <h4 className="text-sm font-medium text-blue-900 mb-2">Gestion future</h4>
                        <ul className="text-sm text-blue-700 space-y-1">
                            <li>• Vous pourrez modifier ces informations</li>
                            <li>• Les enseignants seront assignés ultérieurement</li>
                            <li>• Le budget peut être ajusté chaque année</li>
                            <li>• Les contacts sont importants pour la communication</li>
                        </ul>
                    </div>
                </div>
            </div>
